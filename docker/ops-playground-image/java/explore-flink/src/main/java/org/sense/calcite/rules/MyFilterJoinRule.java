...
//@formatter:off
public abstract class MyFilterJoinRule extends RelOptRule {
	/** Predicate that always returns true. With this predicate, every filter
	  ...
	  public static final MyFilterJoinRule FILTER_ON_JOIN =
	   ...
	   * smart. */
	  public static final MyFilterJoinRule DUMB_FILTER_ON_JOIN =
	      new FilterIntoJoinRule(false, RelFactories.LOGICAL_BUILDER,
	          TRUE_PREDICATE);

	  /** Rule that pushes predicates in a Join into the inputs to the join. */
	  public static final MyFilterJoinRule JOIN =
	   ...
	   * factories.
	   */
	  protected MyFilterJoinRule(RelOptRuleOperand operand, String id,
	      boolean smart, RelBuilderFactory relBuilderFactory, Predicate predicate) {
	    super(operand, relBuilderFactory, "MyFilterJoinRule:" + id);
	    this.smart = smart;
	    this.predicate = Objects.requireNonNull(predicate);
	  }

	  /**
	   * Creates a MyFilterJoinRule with an explicit root operand and
	   * factories.
	   */
	...
	//~ Methods ----------------------------------------------------------------
	  ...
	  public static class JoinConditionPushRule extends MyFilterJoinRule {
	    public JoinConditionPushRule(RelBuilderFactory relBuilderFactory,
	        Predicate predicate) {
	      super(RelOptRule.operand(Join.class, RelOptRule.any()),
	          "MyFilterJoinRule:no-filter", true, relBuilderFactory,
	          predicate);
	    }
	  ...
	  public static class FilterIntoJoinRule extends MyFilterJoinRule {
	    public FilterIntoJoinRule(boolean smart,
	      ...
	      super(
	          ...
	          "MyFilterJoinRule:filter", smart, relBuilderFactory,
	          predicate);
	    }
	    ...
	    @Override public void onMatch(RelOptRuleCall call) {
	    	System.out.println("======================= FilterIntoJoinRule.onMatch ====================");
