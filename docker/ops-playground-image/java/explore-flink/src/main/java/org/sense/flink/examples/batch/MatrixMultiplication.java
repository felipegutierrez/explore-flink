...
public class MatrixMultiplication {
    ...
    public MatrixMultiplication() {
        this("src/main/resources/matrixA.csv", "src/main/resources/matrixB.csv", "file:///tmp/result.csv");
    }

    public MatrixMultiplication(String matrixAFile, String matrixBFile, String sinkFile) {
        this.matrixAFile = matrixAFile;
        this.matrixBFile = matrixBFile;
    ...
    public void execute() throws Exception {
        ...
        DataSet<Tuple4<String, Integer, Integer, Integer>> matrixA = env.readCsvFile(matrixAFile)
        ...
        DataSet<Tuple4<String, Integer, Integer, Integer>> matrixB = env.readCsvFile(matrixBFile)
                .fieldDelimiter(",").types(Integer.class, Integer.class, Integer.class)
        ...
        productMatrixAB.writeAsCsv(sinkFile).setParallelism(1);
    ...
    public class SinkCollector implements SinkFunction<Tuple2<Tuple2<Integer, Integer>, Integer>> {

        public final List<Tuple2<Tuple2<Integer, Integer>, Integer>> result =
                Collections.synchronizedList(new ArrayList<>());

        @Override
        public void invoke(Tuple2<Tuple2<Integer, Integer>, Integer> value, Context context) throws Exception {
