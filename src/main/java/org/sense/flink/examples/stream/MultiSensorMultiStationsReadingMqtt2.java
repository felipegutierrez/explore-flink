...
public class MultiSensorMultiStationsReadingMqtt2 {
	...
	public MultiSensorMultiStationsReadingMqtt2() throws Exception {
		...
		streamStations.filter(new SensorFilter("COUNT_TR"))
				...
				.aggregate(new AverageAggregator("COUNT_TR"), new MyProcessWindowFunction())
				.print();
		// @formatter:on
	...
	public static class AverageAggregator implements
		...
		public Tuple2<String, Double> getResult(Tuple3<Double, Long, Integer> accumulator) {
			...
			if (countMinSketch != null) {
				frequency = countMinSketch.getFrequencyFromSketch(functionName);
			}
	...
	public static class MyProcessWindowFunction
			extends ProcessWindowFunction<Tuple2<String, Double>, Tuple2<String, Double>, Integer, TimeWindow> {

		private static final long serialVersionUID = -40874489412082797L;

		@Override
		public void process(Integer key,
				ProcessWindowFunction<Tuple2<String, Double>, Tuple2<String, Double>, Integer, TimeWindow>.Context context,
				Iterable<Tuple2<String, Double>> counts, Collector<Tuple2<String, Double>> out) throws Exception {

			System.out.println("key: " + key);
			System.out.println("context: " + context);
			System.out.println("context globalState: " + context.globalState());
			System.out.println("context windowState: " + context.windowState());
