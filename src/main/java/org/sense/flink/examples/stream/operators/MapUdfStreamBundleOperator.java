...
public class MapUdfStreamBundleOperator<K, V, IN, OUT> extends AbstractMapUdfStreamBundleOperator<K, V, IN, OUT> {
	...
	public MapUdfStreamBundleOperator(MapBundleFunction<K, V, IN, OUT> function, BundleTrigger<IN> bundleTrigger,
