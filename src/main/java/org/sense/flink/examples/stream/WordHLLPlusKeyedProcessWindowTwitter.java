 ...
 *
 */
public class WordHLLPlusKeyedProcessWindowTwitter {

	public static void main(String[] args) throws Exception {
		new WordHLLPlusKeyedProcessWindowTwitter();
	}

	public WordHLLPlusKeyedProcessWindowTwitter() throws Exception {
		...
		env.execute("WordHLLPlusKeyedProcessWindowTwitter");
	}
	...
	public static class TimeOutDistinctAndCountFunction extends KeyedProcessFunction<Byte, String, String> {
		...
		private transient ValueState<HyperLogLogPlusState> hllStateTwitter;
		...
		public void open(Configuration conf) {
			...
			ValueStateDescriptor<HyperLogLogPlusState> descriptorHLL = new ValueStateDescriptor<>("hllStateTwitter",
		...
		public void processElement(String value, Context ctx, Collector<String> out) throws Exception {
			...
			// update HLL state
			HyperLogLogPlusState currentHLLState = hllStateTwitter.value();
